...
namespace LumenMotion
{
    class HeadControl
    {
        ...
        public HeadControl()
        {
            ...
            locYNeg = new mf("locYNeg", xloc, 0, 70);
            locYZer = new mf("locYZer", xloc, 120, 40);
            locYPos = new mf("locYPos", xloc, 240, 70);

            errXNeg = new mf("", xErr, -160, 50);
            errXZer = new mf("", xErr, 0, 50);
            errXPos = new mf("", xErr, 160, 50);

            errYNeg = new mf("", xErr, -160, 50);
            errYZer = new mf("", xErr, 0, 50);
            errYPos = new mf("", xErr, 160, 50);
        ...
        public void start()
        {
            ...
            motion = new MotionProxy("169.254.108.110", 9559);
