    ...
    public class CommandHandler
    {
        ...
        public bool startHandling()
        {
            if (Program.panel.connection.isConnected)
            {
                if (!isHandling)
                {
                    this.channelSend = Program.panel.connection.channelSend;
                    isHandling = true;
                    return true;
                }
                else
                {
                    return false;
                    MessageBox.Show("Command Handler is already running", "CommandHandler");
                }
            }
            else
            {
                MessageBox.Show("Not Connected to Server", "CommandHandler");
                return false;
            }
        }
        public bool stopHandling()
        {
            ...
            {
                return false;
                MessageBox.Show("Command Handler is not running!", "CommandHandler");
            }
        }
